...
public class StringNode {
    ...
    public static StringNode copy(StringNode str) {
        ...
        */
        ...
        StringNode copyT = copy;
 
        StringNode trav = str.next;
        while(trav!=null){
            
            copyT.next = new StringNode(trav.ch, null); 
    ...
    public static boolean isPrefix(StringNode prefix, StringNode str) {
        ...
        */
        StringNode preTrav = prefix; 
        StringNode trav = str; 
        while(preTrav != null){
            if(preTrav.ch != trav.ch){
                return false; 
            }
    ...
    public static void toUpperCase(StringNode str) {     
        ...
        */  
        ...
        if(str==null){ //base case, whole string passed through or null
            return;
        } else {
